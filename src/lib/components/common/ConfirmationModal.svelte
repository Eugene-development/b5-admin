	...
	>
		<div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
			...
			<div
				...
				class="relative w-full transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:max-w-lg sm:p-6 dark:bg-gray-800"
			...
			>
				...
				<!-- Action buttons -->
				<div
					class="mt-6 flex flex-col space-y-3 sm:mt-4 sm:flex-row-reverse sm:space-y-0 sm:space-x-3 sm:space-x-reverse"
				>
					<!-- Confirm button -->
					<button
