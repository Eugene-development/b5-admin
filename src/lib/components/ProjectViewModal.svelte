										...
										<dd class="mt-1 text-sm text-gray-900 dark:text-white">
											{#if acceptedByCurrentUser}
												...
												<div class="flex items-center space-x-2">
													<span
														class="inline-flex items-center rounded-full bg-emerald-100 px-2 py-1 text-xs font-medium text-emerald-800 dark:bg-emerald-900/20 dark:text-emerald-400"
													>
														✓
													</span>
													<span
													...
													{#if acceptedByCurrentUser.user.email && acceptedByCurrentUser.user.name}
														...
														>
													{/if}
													<span class="text-xs text-emerald-600 italic dark:text-emerald-400"
														>(только что)</span
													>
												</div>
