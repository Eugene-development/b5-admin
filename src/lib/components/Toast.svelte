<script>
	...
	const typeConfig = {
		success: {
			...
			buttonClass: 'bg-green-50 text-green-500 hover:bg-green-100 focus:ring-green-600 focus:ring-offset-green-50 dark:bg-green-900/20 dark:text-green-400 dark:hover:bg-green-900/40',
		...
		error: {
			...
			buttonClass: 'bg-red-50 text-red-500 hover:bg-red-100 focus:ring-red-600 focus:ring-offset-red-50 dark:bg-red-900/20 dark:text-red-400 dark:hover:bg-red-900/40',
		...
		warning: {
			...
			buttonClass: 'bg-yellow-50 text-yellow-500 hover:bg-yellow-100 focus:ring-yellow-600 focus:ring-offset-yellow-50 dark:bg-yellow-900/20 dark:text-yellow-400 dark:hover:bg-yellow-900/40',
		...
		info: {
			...
			buttonClass: 'bg-blue-50 text-blue-500 hover:bg-blue-100 focus:ring-blue-600 focus:ring-offset-blue-50 dark:bg-blue-900/20 dark:text-blue-400 dark:hover:bg-blue-900/40',
	...
	>
		<div class="flex">
			<div class="flex-shrink-0">
				<svg class="h-5 w-5 {config.iconClass}" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
					{@html config.icon}
				</svg>
			</div>
			<div class="ml-3">
				...
				<div class="ml-auto pl-3">
					<div class="-mx-1.5 -my-1.5">
						<button
							...
							class="inline-flex rounded-md p-1.5 focus:outline-none focus:ring-2 focus:ring-offset-2 {config.buttonClass}"
