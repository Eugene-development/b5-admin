				...
				<div class="mt-2 text-sm text-blue-700">
					...
					<p><strong>Access Level:</strong> 
						{#if domainState.isAdminDomain}
							<span class="text-green-600 font-semibold">Admin Domain ✅</span>
						{:else if domainState.isLocalhost}
							<span class="text-yellow-600 font-semibold">Development (localhost) ⚠️</span>
						{:else if domainState.isRegularDomain}
							<span class="text-red-600 font-semibold">Regular Domain ❌</span>
						{:else}
					...
					{#if showDetails}
						<div class="mt-3 space-y-1">
							<p><strong>Admin Navigation Access:</strong> 
								{navigationVisibility.hasAdminAccess ? '✅ Enabled' : '❌ Disabled'}
							</p>
							<p><strong>Show /test link:</strong> 
								{navigationVisibility.showTest ? '✅ Visible' : '❌ Hidden'}
							</p>
							<p><strong>Show /test2 link:</strong> 
