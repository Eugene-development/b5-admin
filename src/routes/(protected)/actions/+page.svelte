	...
	<div class="mx-auto max-w-4xl">
		<div class="rounded-lg bg-white p-8 shadow-lg">
			<div class="mb-8 text-center">
				<h1 class="mb-4 text-4xl font-bold text-gray-900">Акции</h1>
				<p class="text-lg text-gray-600">Управление акциями и промо-кампаниями системы</p>
			</div>
				...
				<div class="rounded-lg bg-green-50 p-6">
					...
					<div class="space-y-2 text-green-800">
						<div class="flex items-center">
							...
							<span>Создание акций</span>
						</div>
						<div class="flex items-center">
							<span class="mr-2 h-2 w-2 rounded-full bg-green-500"></span>
							<span>Управление промо-кампаниями</span>
						</div>
						<div class="flex items-center">
							<span class="mr-2 h-2 w-2 rounded-full bg-green-500"></span>
							<span>Мониторинг эффективности</span>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="mt-8 rounded-lg bg-gray-50 p-6">
				...
				<p class="text-gray-700">
					На этой странице осуществляется управление акциями и промо-кампаниями, создание
					специальных предложений и мониторинг их эффективности. Страница доступна для пользователей
					доменов rubonus.info, bonus.band и admin.bonus.band.
				</p>
			</div>
