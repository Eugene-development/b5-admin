...
<div class="flex min-h-screen items-center justify-center bg-gradient-to-br from-red-950 via-black to-gray-900 p-4">
	<div class="animate-fade-in-up w-full max-w-4xl">
		<!-- Агрессивная карточка с предупреждением -->
		<div class="relative overflow-hidden rounded-3xl border-4 border-red-600 bg-black shadow-2xl shadow-red-900/50">
			<!-- Анимированный фон с предупреждающими полосами -->
			<div class="absolute inset-0 opacity-10">
				<div class="h-full w-full bg-[repeating-linear-gradient(45deg,transparent,transparent_35px,rgba(239,68,68,0.3)_35px,rgba(239,68,68,0.3)_70px)]"></div>
			</div>

			<!-- Пульсирующее свечение -->
			<div class="absolute inset-0 animate-pulse bg-gradient-to-r from-red-600/20 via-transparent to-red-600/20"></div>
			...
			<div class="relative z-10 p-8 text-center md:p-16">
				...
				<div class="mb-8 flex justify-center">
					<div class="relative">
						...
						<!-- Основная иконка -->
						<div class="relative flex h-32 w-32 items-center justify-center rounded-full border-4 border-red-600 bg-gradient-to-br from-red-900 to-black shadow-2xl shadow-red-600/50">
				...
				<div class="mb-8 space-y-4">
					<p class="text-xl font-bold text-red-400 md:text-2xl">
				...
				<!-- Информационный блок -->
				<div class="mx-auto mb-8 max-w-2xl rounded-2xl border-2 border-red-800 bg-red-950/50 p-6 backdrop-blur-sm">
					<div class="space-y-3 text-left">
						<div class="flex items-start space-x-3">
							<svg class="mt-1 h-6 w-6 flex-shrink-0 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
								<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
							</svg>
							<p class="text-gray-300">
								<span class="font-bold text-red-400">Причина блокировки:</span> Статус пользователя не определён
							</p>
						</div>
						<div class="flex items-start space-x-3">
							<svg class="mt-1 h-6 w-6 flex-shrink-0 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
							...
							<p class="text-gray-300">
								<span class="font-bold text-red-400">Требуемые статусы:</span> Клиент, Агент или Дизайнер
							</p>
						</div>
						<div class="flex items-start space-x-3">
							<svg class="mt-1 h-6 w-6 flex-shrink-0 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
							...
							<p class="text-gray-300">
								<span class="font-bold text-red-400">Действие:</span> Обратитесь к администратору системы для назначения корректного статуса
							</p>
						</div>
					</div>
				</div>
		...
		<div class="absolute left-1/4 top-1/4 -z-10 h-96 w-96 animate-pulse rounded-full bg-red-600/10 blur-3xl"></div>
		<div class="absolute bottom-1/4 right-1/4 -z-10 h-96 w-96 animate-pulse rounded-full bg-red-800/10 blur-3xl" style="animation-delay: 1s;"></div>
	</div>
</div>
